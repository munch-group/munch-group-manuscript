...
def rename_library(new_name: str):
    """Rename the library from munch-group-manuscript to the new name."""
    old_hyphen = "munch-group-manuscript"
...
def main():
    ...
    # Confirm with user
    print(f"\nThis will rename 'munch-group-manuscript' to '{new_name}' throughout the project.")
